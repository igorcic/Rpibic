...
# Avaliação de Insfraestrutura Discentes
\newline
...
kable(quadrodisgestaortotal16,
      caption = "Avaliação de Insfraestrutura Discentes", format = "html", 
      escape = FALSE,   # considera o <br> uma quebra de linha
      format.args = list(big.mark = "."), digits = 2, 
      align = "r")  %>% 
  row_spec(0, align = "r") %>% kable_styling(bootstrap_options = c("striped", "hover", "responsive"), full_width = F, font_size = 14)
...
kable(quadrotecgestaortotal16,
      caption = "Avaliação de Insfraestrutura Tecnicos", format = "html", 
      escape = FALSE,   # considera o <br> uma quebra de linha
      format.args = list(big.mark = "."), digits = 2, 
      align = "r")  %>% 
  row_spec(0, align = "c") %>% kable_styling(bootstrap_options = c("striped", "hover", "responsive"), full_width = F, font_size = 14)
...
kable(quadrodocgestaortotal16,
      caption = "Avaliação de Insfraestrutura Doscente", format = "html", 
      escape = FALSE,   # considera o <br> uma quebra de linha
      format.args = list(big.mark = "."), digits = 2, 
      align = "r")  %>% 
  row_spec(0, align = "c") %>% kable_styling(bootstrap_options = c("striped", "hover", "responsive"), full_width = F, font_size = 14)
...
# Avaliação Estudantil: Incentivo UNB
\newline
A Comunidade estudantil avaliou em 2021 se a unb incentiva a atividades academicas
\newline
...
kable(quadroAlunototal9,
      caption = "Avaliação Estudantil: Incentivo UNB", format = "html", 
      escape = FALSE,   # considera o <br> uma quebra de linha
      format.args = list(big.mark = "."), digits = 2, 
      align = "r")  %>% 
  row_spec(0, align = "r") %>% kable_styling(bootstrap_options = c("striped", "hover", "responsive"), full_width = F, font_size = 14)
...
kable(quadroturno ,
      caption = "Turno: Tecnico", format ="html",
      escape = FALSE,   # considera o <br> uma quebra de linha
      format.args = list(big.mark = "."), digits = 2, 
      align = "lrrr")  %>% 
  row_spec(0, align = "c") %>% kable_styling(bootstrap_options = c("striped", "hover", "responsive"), full_width = F)
